      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="card">
              <img src="public/assets/img/more-service-1.jpg" class="card-img-top" alt="...">
              <div class="card-body">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="card">
              <img src="public/assets/img/more-service-2.jpg" class="card-img-top" alt="...">
              <div class="card-body">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="card">
              <img src="public/assets/img/more-service-3.jpg" class="card-img-top" alt="...">
              <div class="card-body">
    ...
    <section class="info-box py-0">
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-5 align-items-stretch order-1 order-lg-2 img" style="background-image: url(public/assets/img/info-box.jpg);">&nbsp;</div>
        </div>
